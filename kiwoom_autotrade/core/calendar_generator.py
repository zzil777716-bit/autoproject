...
class DesktopCalendarGenerator:
    ...
    def update_and_build(self, api_instance=None) -> str:
        """HTS 데이터를 수집하여 월간 엑셀 시트 갱신, 히스토리에 적재 및 바탕화면 캘린더 생성"""
        # 1. 1달 단위 통합 엑셀 워크북(HTS_테마_주도주_분석_YYYY-MM.xlsx) 업데이트
        ...
        # 5. 구글 드라이브(Antigravity/캘린더)로 자동 동기화
