...
bat_dash_code = '@echo off\r\ncd /d D:\\ANTIGRAVITY(자동매매)\r\n"C:\\Users\\HONG\\AppData\\Local\\Programs\\Python\\Python310-32\\python.exe" D:\\ANTIGRAVITY(자동매매)\\dashboard_app.py\r\n'
...
bat_con_code = '@echo off\r\ncd /d D:\\ANTIGRAVITY(자동매매)\r\n"C:\\Users\\HONG\\AppData\\Local\\Programs\\Python\\Python310-32\\python.exe" D:\\ANTIGRAVITY(자동매매)\\multibot_launcher.py\r\npause\r\n'
...
s1.Arguments = r"D:\ANTIGRAVITY(자동매매)\dashboard_app.py"
s1.WorkingDirectory = r"D:\ANTIGRAVITY(자동매매)"
s1.Description = "Antigravity PyQt5 Trading Dashboard"
s1.Save()
...
s2.Arguments = r"D:\ANTIGRAVITY(자동매매)\multibot_launcher.py"
s2.WorkingDirectory = r"D:\ANTIGRAVITY(자동매매)"
s2.Description = "Antigravity Multi-Bot Launcher"
s2.Save()

print(">> [SUCCESS] Clean PyQt5 Desktop Launchers Created!")
